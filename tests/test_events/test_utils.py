...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["html/body/svg/g/rect[82]", "html body svg g rect:nth-of-type(82)"],
        ["html/body/svg/g/rect", "html body svg g rect"],
        ["html/body/svg/g/g/g/g/rect", "html body svg g g g g rect"],
        [
